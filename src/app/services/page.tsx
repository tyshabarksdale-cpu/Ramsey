  ...
  return (
    <div className="py-16 lg:py-32">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center mb-16 sm:mb-24 space-y-8 flex flex-col items-center">
          <div className="inline-flex items-center gap-2 px-6 py-2 rounded-full bg-primary/10 text-primary font-bold text-sm uppercase tracking-widest mb-4">
            Our Offerings
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 mb-20 sm:mb-32 max-w-7xl mx-auto">
          {services.map((service, i) => (
            <Card key={i} className="relative overflow-hidden group border-none shadow-lg hover:shadow-2xl transition-all duration-500 bg-white text-center rounded-[2rem]">
              <CardHeader className="p-10 sm:p-12 space-y-6">
                <div>
                  <CardTitle className="text-3xl sm:text-4xl font-headline mb-6 text-primary">{service.title}</CardTitle>
                  <CardDescription className="text-lg sm:text-xl leading-relaxed text-primary/70">{service.description}</CardDescription>
                </div>
              </CardHeader>
              <CardContent className="p-10 sm:p-12 pt-0 space-y-10">
                <ul className="space-y-4 sm:space-y-6 flex flex-col items-center w-full">
                ...
                <div className="pt-8 sm:pt-10 border-t border-secondary">
                  <p className="text-xs font-bold text-primary/60 uppercase tracking-widest mb-3">Investment</p>
        ...
        <section className="mb-20 sm:mb-32">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center max-w-6xl mx-auto">
            ...
            <div className="space-y-10 text-center lg:text-left">
              ...
              <div className="space-y-6 sm:space-y-8 text-xl sm:text-2xl text-primary/80 italic font-headline leading-relaxed">
                <p>
        ...
        <div className="bg-ombre-dark text-primary-foreground rounded-[3rem] p-10 sm:p-20 lg:p-24 shadow-2xl relative overflow-hidden max-w-7xl mx-auto">
          <div className="absolute top-0 right-0 w-96 h-96 bg-accent/10 blur-[150px] rounded-full"></div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 sm:gap-24 items-center relative z-10">
            <div className="space-y-10 sm:space-y-16 text-center">
              <div className="space-y-6">
                <Badge variant="outline" className="border-accent/30 text-accent px-6 py-2 text-sm">The Methodology</Badge>
                <h2 className="text-4xl sm:text-5xl lg:text-7xl font-headline text-white">The Empowerment Process</h2>
              </div>
              <div className="space-y-12 sm:space-y-16">
                {[
                  ...
                  <div key={idx} className="flex flex-col items-center text-center gap-6">
                    <div className="flex-shrink-0 w-16 h-16 rounded-full border border-accent/40 flex items-center justify-center font-headline font-bold text-3xl text-accent mx-auto">{item.step}</div>
                    <div>
                      <h4 className="text-2xl sm:text-3xl font-bold mb-4 text-white">{item.title}</h4>
            ...
            <div className="grid grid-cols-2 gap-6 sm:gap-10">
              {[
                ...
                <Card key={idx} className="bg-white/5 border-white/10 text-primary-foreground p-8 sm:p-12 text-center flex flex-col items-center justify-center gap-6 group hover:bg-white/10 transition-all aspect-square rounded-[2rem]">
        ...
        <div className="mt-20 sm:mt-32 text-center space-y-12 flex flex-col items-center">
          <h2 className="text-4xl sm:text-5xl lg:text-7xl font-headline text-primary">Ready to start pedaling?</h2>
          <Button asChild size="lg" className="w-full sm:w-auto rounded-full px-16 h-20 text-2xl font-bold bg-accent hover:bg-accent/90 shadow-xl text-white font-headline tracking-wide">
